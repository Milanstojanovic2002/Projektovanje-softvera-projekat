 ...
 * @author Milan
 */
public class FrmNoviPredavac extends javax.swing.JFrame {

    /**
     * Creates new form FrmNoviPredavac
     */
    private FrmPredavac frmPredavac;

    public FrmNoviPredavac(FrmPredavac frmPredavac) {
        initComponents();
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txtPrezime, javax.swing.GroupLayout.DEFAULT_SIZE, 129, Short.MAX_VALUE)
    ...
    private void btnUnesiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUnesiActionPerformed
        ...
        if (validirajFormu(ime, prezime, jmbg, indeks)) {
            try {
                ...
                predavac.setIme(txtIme.getText());
                predavac.setPrezime(txtPrezime.getText());
                predavac.setJmbg(Long.valueOf(txtJmbg.getText()));
                predavac.setPanelid((Panel) cmbPaneli.getSelectedItem());
                Controller.getInstance().kreirajPredavaca(predavac);
                JOptionPane.showMessageDialog(this, "Predavac saved!\nGenerated ID: [" + predavac.getId() + "]", "Create Predavac", JOptionPane.INFORMATION_MESSAGE);

                frmPredavac.popuniTabelu();
                dispose();
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(this, "Predavac not saved!\n" + ex.getMessage(), "Create Predavac", JOptionPane.ERROR_MESSAGE);
            }
        }
