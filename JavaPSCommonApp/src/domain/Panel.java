...
public class Panel extends DomainObject implements Serializable {
    ...
    public Panel(int id, String naziv, LocalDate datum) {
        this.id = id;
        this.naziv = naziv;
        this.datum = datum;
    }
    ...
    public List<DomainObject> getParamsForSelect(ResultSet rs) throws SQLException {
        List<DomainObject> paneli = new ArrayList<>();
        ...
        return (List<DomainObject>) paneli;
    }
