 ...
 * @author Milan
 */
public class Sala extends DomainObject implements Serializable{
    ...
    public Sala(int id, String naziv, int kapacitet, TipSale tipSale) {
        this.id = id;
        this.naziv = naziv;
    ...
    public boolean equals(Object obj) {
        ...
        return this.tipSale == other.tipSale;
    }
    ...
    public List<DomainObject> getParamsForSelect(ResultSet rs) throws SQLException {
        List<DomainObject> sale=new ArrayList<>();
        while (rs.next()) {
                Sala s = new Sala();
                s.setId(rs.getInt("id"));
                s.setNaziv(rs.getString("naziv"));
                s.setKapacitet(rs.getInt("kapacitet"));
                s.setTipSale(TipSale.valueOf(rs.getString("tipSale")));
                sale.add(s);
            }
        return (List<DomainObject>) sale;
    }
